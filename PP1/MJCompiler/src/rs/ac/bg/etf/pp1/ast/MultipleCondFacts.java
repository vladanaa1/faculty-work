...
public class MultipleCondFacts extends CondFactList {

    private CondFactList CondFactList;
    private CondFact CondFact;

    public MultipleCondFacts (CondFactList CondFactList, CondFact CondFact) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleCondFacts(\n");

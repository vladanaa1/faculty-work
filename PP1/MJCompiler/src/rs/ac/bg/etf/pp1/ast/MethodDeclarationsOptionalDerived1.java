...
public class MethodDeclarationsOptionalDerived1 extends MethodDeclarationsOptional {

    private MethodDeclarationList MethodDeclarationList;

    public MethodDeclarationsOptionalDerived1 (MethodDeclarationList MethodDeclarationList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodDeclarationsOptionalDerived1(\n");
